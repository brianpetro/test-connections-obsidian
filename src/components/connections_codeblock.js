...
export async function render(connections_list, opts = {}) {
  ...
  const container = /** @type {import('../smart-types/index.js').ConnectionsViewElement} */ (frag.firstElementChild);
 ...
 * @this {import('../smart-types/index.js').ConnectionsComponentContext}
 * @param {import('../smart-types/index.js').ConnectionsListScope} connections_list
 * @param {import('../smart-types/index.js').ConnectionsViewElement} container
 * @param {import('../smart-types/index.js').ConnectionsComponentOptions} opts
 * @returns {Promise<import('../smart-types/index.js').ConnectionsViewElement>}
 */
 ...
 * @param {import('../smart-types/index.js').ConnectionsListScope} connections_list
 * @param {import('../smart-types/index.js').ConnectionsComponentOptions} [opts]
 * @returns {Promise<import('../smart-types/index.js').ConnectionResult[]>}
 */
