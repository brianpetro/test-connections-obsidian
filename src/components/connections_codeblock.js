...
export async function render(connections_list, opts = {}) {
  ...
  const container = /** @type {import('jsbrains/smart-types').ConnectionsViewElement} */ (frag.firstElementChild);
 ...
 * @param {import('jsbrains/smart-types').ConnectionsComponentOptions} opts
 * @returns {Promise<import('jsbrains/smart-types').ConnectionsViewElement>}
 */
 ...
 * @param {import('jsbrains/smart-types').ConnectionsListScope} connections_list
 * @param {import('jsbrains/smart-types').ConnectionsComponentOptions} [opts]
 * @returns {Promise<import('jsbrains/smart-types').ConnectionResult[]>}
 */
