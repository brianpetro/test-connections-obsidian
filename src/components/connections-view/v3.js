...
/** @typedef {import('jsbrains/smart-types/index.js').ConnectionsListSettings} ConnectionsListSettings */
/** @typedef {import('jsbrains/smart-types/index.js').ConnectionsMenu} ConnectionsMenu */
/** @typedef {import('jsbrains/smart-types/index.js').ConnectionsViewElement} ConnectionsViewElement */
    ...
    menu_button?.addEventListener('click', (event) => {
      ...
      env.build_menu?.(
        ...
        state.connections_list,
        {
          ...
          visible_results,
          render_connections: /** @type {import('jsbrains/smart-types/index.js').ConnectionsActionParams['render_connections']} */ (
