...
/** @typedef {import('jsbrains/smart-types').ConnectionsListSettings} ConnectionsListSettings */
    ...
    menu_button?.addEventListener('click', (event) => {
      ...
      env.build_menu?.(
        ...
        state.connections_list,
        {
          ...
          visible_results,
          render_connections: /** @type {import('jsbrains/smart-types').ConnectionsActionParams['render_connections']} */ (
