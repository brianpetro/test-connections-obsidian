 ...
 * @this {import('../../smart-types/index.js').ConnectionsComponentContext}
 * @param {import('../../smart-types/index.js').ConnectionResult} result - The results a <Result> object 
 * @param {import('../../smart-types/index.js').ConnectionsComponentOptions} [params={}] - Optional parameters.
 ...
 * @this {import('../../smart-types/index.js').ConnectionsComponentContext}
 * @param {import('../../smart-types/index.js').ConnectionResult} result_scope - The result object containing component data.
 * @param {import('../../smart-types/index.js').ConnectionsComponentOptions} [params={}] - Optional parameters.
...
export async function post_process(result_scope, container, params = {}) {
  ...
  const env = item.env;
  const plugin = /** @type {import('../../smart-types/index.js').ConnectionsPlugin} */ (env.smart_connections_plugin);
  ...
  const render_result = async (_result_elm) => {
    if (!_result_elm.querySelector('li').innerHTML) {
      const collection_key = /** @type {import('../../smart-types/index.js').ConnectionsCollectionKey} */ (_result_elm.dataset.collection);
      const entity = /** @type {import('../../smart-types/index.js').ConnectionItem} */ (
  ...
  plugin.registerDomEvent(container, 'contextmenu', (event) => {
    ...
    const connections_list = /** @type {import('../../smart-types/index.js').ConnectionsListScope} */ (result_scope.connections_list);
    ...
    const menu = /** @type {import('../../smart-types/index.js').ConnectionsMenu} */ (new Menu());
 ...
 * @param {import('../../smart-types/index.js').ConnectionsComponentSettings} [component_settings]
 * @returns {string}
 */
...
/**
 * @param {import('../../smart-types/index.js').ConnectionItem|null|undefined} entity
 * @returns {boolean}
 */
