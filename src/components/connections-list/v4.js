 ...
 * @param {import('../../smart-types/index.js').ConnectionsComponentOptions} [opts]
 ...
 * @this {import('../../smart-types/index.js').ConnectionsComponentContext}
 * @param {import('../../smart-types/index.js').ConnectionsListScope} connections_list
 * @param {import('../../smart-types/index.js').ConnectionsComponentOptions} [opts={}] - Optional parameters, including `opts.results`.
...
function register_graph_events(graph, list_container) {
  ...
  graph.addEventListener('connections:result', (event) => {
    const detail = /** @type {CustomEvent<import('../../smart-types/index.js').ConnectionsGraphResultEventDetail>} */ (event).detail;
...
/**
 * @param {HTMLElement} list_container
 * @param {Partial<import('../../smart-types/index.js').ConnectionsGraphResultEventDetail>} [detail]
 */
