...
function register_graph_events(graph, list_container) {
  ...
  graph.addEventListener('connections:result', (event) => {
    const detail = /** @type {CustomEvent<import('jsbrains/smart-types').ConnectionsGraphResultEventDetail>} */ (event).detail;
...
/**
 * @param {HTMLElement} list_container
 * @param {Partial<import('jsbrains/smart-types').ConnectionsGraphResultEventDetail>} [detail]
 */
