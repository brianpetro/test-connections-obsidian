...
/** @typedef {import('../smart-types/index.js').ConnectionsSettingsTabScope} ConnectionsSettingsTabScope */
...
export class ScEarlySettingsTab extends SmartPluginSettingsTab {
  ...
  async render_plugin_settings(container) {
    ...
    const connections_lists_settings_config = /** @type {import('../smart-types/index.js').SettingsConfig} */ (
