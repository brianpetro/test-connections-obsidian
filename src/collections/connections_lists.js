...
/** @typedef {import('jsbrains/smart-types/index.js').ConnectionsListsCollection} ConnectionsListsCollection */
...
export class ConnectionsLists extends Collection {
  ...
  /**
   * @param {SmartEnv} env
   * @param {import('jsbrains/smart-types/index.js').CollectionOptions} [opts]
   */
   ...
   * @returns {import('jsbrains/smart-types/index.js').ConnectionsListScope}
   */
  new_item(item) {
  ...
  get connections_list_component_settings_config() {
    ...
    const config = typeof component_module?.settings_config === 'function'
      ? /** @type {(scope: ConnectionsListsCollection) => import('jsbrains/smart-types/index.js').SettingsConfig} */ (
        component_module.settings_config
      )(this)
      : /** @type {import('jsbrains/smart-types/index.js').SettingsConfig|undefined} */ (component_module?.settings_config)
    ;
...
export function settings_config(scope) {
  /** @type {import('jsbrains/smart-types/index.js').SettingsConfig} */
  let config = {
    "results_collection_key": {
      name: "Connection results type",
      type: "dropdown",
