...
export const menus = /** @type {import('../../smart-types/index.js').ConnectionsMenusConfig & {'connections:list_menu': {title: (this: import('../../smart-types/index.js').ConnectionsMenuContext & {scope: import('../../smart-types/index.js').ConnectionsListScope}) => string, icon: (this: import('../../smart-types/index.js').ConnectionsMenuContext & {scope: import('../../smart-types/index.js').ConnectionsListScope}) => string}}} */ ({
