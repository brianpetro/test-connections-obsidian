...
export async function connections_list_open_random_connection(params = {}) {
  ...
  const scope_item = /** @type {{item?: import('jsbrains/smart-types/index.js').ConnectionItem}} */ (
    /** @type {unknown} */ (this)
  ).item;
 ...
 * @param {import('jsbrains/smart-types/index.js').ConnectionsActionParams} [params]
 * @returns {import('jsbrains/smart-types/index.js').ConnectionsApp|null}
 */
function get_app(env, params = {}) {
  return params.app
    ...
    || env?.obsidian_app
    || env?.plugin?.app
    || /** @type {Window & {app?: import('jsbrains/smart-types/index.js').ConnectionsApp}} */ (activeWindow).app
    || null
  ;
}

/**
 * @param {import('jsbrains/smart-types/index.js').ConnectionItem|undefined} scope_item
 * @param {import('jsbrains/smart-types/index.js').ConnectionsActionParams} [params]
 * @param {import('jsbrains/smart-types/index.js').ConnectionsApp|null} [app]
 * @returns {string}
 */
...
export const menus = {
  'connections:list_menu': {
    ...
    order: 40,
    /**
     * @param {import('jsbrains/smart-types/index.js').ConnectionsMenuContext} _menu_ctx
     * @param {Event} [event]
     */
