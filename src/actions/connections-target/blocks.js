...
/**
 * @param {import('../../smart-types/index.js').ConnectionsMenuContext} menu_ctx
 * @returns {import('../../smart-types/index.js').ConnectionItem[]}
 */
function resolve_target_candidates(menu_ctx) {
  const action = /** @type {((params: import('../../smart-types/index.js').ConnectionsActionParams) => import('../../smart-types/index.js').ConnectionItem[])|undefined} */ (
...
/**
 * @param {import('../../smart-types/index.js').ConnectionItem} block
 * @returns {number}
 */
...
/**
 * @param {import('../../smart-types/index.js').ConnectionsMenuContext} menu_ctx
 * @param {import('../../smart-types/index.js').ConnectionItem} target_item
 * @returns {Promise<boolean>}
 */
async function run_select_target(menu_ctx, target_item) {
  const action = /** @type {((params: import('../../smart-types/index.js').ConnectionsActionParams) => boolean|Promise<boolean>)|undefined} */ (
