 ...
 * @returns {Promise<import('../smart-types/index.js').ConnectionResult|null>}
 */
export async function get_random_connection(env, file_path, { rng = Math.random } = {}) {
  ...
  let connections = [];
  try {
    connections = /** @type {import('../smart-types/index.js').ConnectionResult[]} */ (
...
/**
 * @param {import('../smart-types/index.js').ConnectionResult[]} connections
 * @param {{rng: () => number}} options
 * @returns {import('../smart-types/index.js').ConnectionResult|undefined}
 */
